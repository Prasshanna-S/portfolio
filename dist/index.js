(() => {
  ...
  var Grid = class {
    ...
    createBlocks() {
      ...
      let wid = 0, tries = 0, maxTries = 1e3;
    ...
    startAutoReveal() {
      ...
      const loop = () => {
        ...
        const tl = gsapWithCSS.timeline({ onComplete: loop });
        tl.to(bs, {
          rotationY: 180,
          bubbleAlpha: 1,
          duration: 1,
